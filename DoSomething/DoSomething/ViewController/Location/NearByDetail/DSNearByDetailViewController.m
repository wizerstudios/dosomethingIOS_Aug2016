...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ( indexPath.row ==1)
    {
        NSString *objstr=[userDetailsArray valueForKey:@"about"];
         dataSize = [COMMON getControlHeight:objstr withFontName:@"Patron-Medium" ofSize:10.0 withSize:CGSizeMake(tableView.frame.size.width,tableView.frame.size.height)];
        ...
        else
        {
            ...
            return self.aboutviewHeight.constant;
       }
